...
def result_path_gen(image_type, sample_num, image_num):
    """
    生成结果路径。
    ...
    result_path = os.path.join("samples", image_type_path,
                                     "sample" + str(sample_num).zfill(2), 
                                     "result", 
                                     "result_" + str(image_num).zfill(2) + 
                                     ".jpg")
    return result_path
...
if __name__ == '__main__':
    ...
    # 保存结果
    result_path = result_path_gen(image_type, sample_num, image_num)
